...
{: .box-note}
이 포스트는 ETRI의 손석호 박사의 Blog 내용을 그대로 옮겨 온 것입니다.
오픈소스 프로젝트의 주요 개발 플랫폼인 GitHub 경험 차원에서 게시하였습니다. &#128525;
...
데모 웹사이트 확인: [https://panbong.github.io](https://panbong.github.io)
...
[손석호씨가 만든 동영상 가이드: 약 10분](https://www.youtube.com/watch?v=UgPZXxL2jSw)
...
1. 웹사이트의 기본 소스를 제공하는 GitHub 저장소에 접속하고, `Fork` 를 통해 해당 저장소를 본인의 GitHub 계정으로 복제합니다.
    ...
    1. [https://github.com/panbong/panbong.github.io](https://github.com/panbong/panbong.github.io) 저장소에 접속
       ![GitHub 저장소 접속](../assets/img/githubpage-guide/g2.jpg)

    1. [https://panbong.github.io](https://panbong.github.io) 접속을 통해 데모 웹사이트 확인
